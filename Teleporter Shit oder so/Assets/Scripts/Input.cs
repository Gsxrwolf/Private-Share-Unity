...
public partial class @Input: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Stuff_Jump = m_Stuff.FindAction("Jump", throwIfNotFound: true);
    ...
    private readonly InputAction m_Stuff_Jump;
    private readonly InputAction m_Stuff_WASD;
    private readonly InputAction m_Stuff_Mouse;
    public struct StuffActions
    {
        private @Input m_Wrapper;
        public StuffActions(@Input wrapper) { m_Wrapper = wrapper; }
        public InputAction @Jump => m_Wrapper.m_Stuff_Jump;
